...
function createQueue(maxSize) {
  ...
  var Queue = {
    ...
    flush: function flush() {
      var data = appendMetadataToEvents(buffer);
      ...
      this.clear();
      sendData("".concat(API_URL, "/events"), json);
    },
...
},{"./metadata":2,"./sendData":4}],4:[function(require,module,exports){
"use strict";

require("whatwg-fetch");

var sendData = function sendData(url, json) {
  if (true) {
    fetch(url, {
      method: "POST",
      mode: "cors",
...
},{"whatwg-fetch":1}],5:[function(require,module,exports){
"use strict";
